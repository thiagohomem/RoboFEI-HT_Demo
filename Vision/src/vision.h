...
#define RESOLUCAO_X 640 //1920...1280...640
#define RESOLUCAO_Y 480  //1080...720...480

#define CENTERBALL 0.07 // Porcentagem de quanto centraliza a bola no quadro
#define AJUSTE 0.2 // para resolução de 640x480
...
double detect( IplImage *img, double &posx, double &posy,  IplImage*  Quadro_hsv, IplImage*  segmentada); // funcao
